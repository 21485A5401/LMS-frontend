...
const School_Login = ({setTriggerRefresh}) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await instance.post('app/v1/school-admins/login', data);
      ...
      if (response.data.message === 'Invalid login credentials') {
        ...
        toast.success("School Admin Login Successfully!")
          ...
          <LoginPageWrapper>
            ...
            <LoginForm type="submit" onSubmit={handleSubmit}>
              ...
              <LoginPasswordInputWrapper>
                ...
                <EyeIcon src="https://cdn.builder.io/api/v1/image/assets/TEMP/fa8f1c44acad6ed5730e79060bffccf31ac60bc5398f53a188aec092b8f1b1e7?apiKey=00c981949ae441738146aeab96db3c11&" alt="Toggle password visibility" onClick={togglePasswordvissable} />
              </LoginPasswordInputWrapper>
