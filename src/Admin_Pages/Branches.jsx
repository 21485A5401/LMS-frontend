        ...
        <Container>
          ...
          <Button>Import CSV</Button>
            ...
            <DForm>
              ...
              <Input placeholder="Enter Superintendent name" name="superintendentname" onChange={handleChange} />
            </DForm>
          </Header>
          <Content>
            {/* <LeftColumn>
            ...
            <RightColumn>
              <SFormGroup>
                ...
                <FormGroup>
                  ...
                  <Input type="text" placeholder="Location" name="branchname" onChange={handleChange} />
                </FormGroup>
              </SFormGroup>
              <FormGroup>
                <Label>Address</Label>
              ...
              <FInputRow>
                ...
                <FormGroup>
                  ...
                  <Input type="Number" placeholder="Enter phone number" name="phonenumber" onChange={handleChange} />
                </FormGroup>
                <FormGroup>
                  <Label>Gender</Label>
          ...
          <Footer>
            <Button variant="secondary" onClick={() => { navigate("/Dashdoard") }}>Cancel</Button>
